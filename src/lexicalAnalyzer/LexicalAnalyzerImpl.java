...
import domain.Token;
import lexicalAnalyzer.lexicalExceptions.*;
...
public class LexicalAnalyzerImpl implements LexicalAnalyzer {
    ...
    private int lexemeLength() {return  currentLexeme.length();}

    private boolean lexemeIsReservedKeyword() {return Arrays.asList(reservedKeywords).contains(currentLexeme);}
